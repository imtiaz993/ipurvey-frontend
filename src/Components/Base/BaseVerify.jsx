...
import headImg from '../../Assets/undraw_envelope_re_f5j4.png';
import { resendVerificationEmail } from '../../Query/queryFunctions';

const BaseVerify = ({ res, PObj }) => {
 ...
 useEffect(async () => {
  ...
  localStorage.setItem('verification-method', 'base');
  localStorage.setItem('POBJ', JSON.stringify(PObj));
   ...
   <div className='account_form_md'>
    <div className='account_form_sd'>
     <div className='form_head_md'>
      ...
      <img src={headImg} alt='...' className='base-verify-img' />
      ...
      <div className='home_form_div_sd'>
       ...
       <div className='eye_md'>
        <input
         ...
         disabled={true}
        />
        {/* <img src={edit} id='edit-verify-email' alt='...' /> */}
       </div>
       {error.email && (
        <div className='getError_md_start'>
         <img src={errorIcon} alt='...' />
